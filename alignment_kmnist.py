...
if __name__ == '__main__':
    ...
    if part == 1:  # Train networks to compute alignment
        ...
        alignments = []
        for scale in [8, 16, 32, 64, 128, 256, 512]:
            name = 'kmnist_normal_x' + str(scale) + '_100'
            baseline = 'kmnist_align_x' + str(scale) + '_100'
            initialization = 'kmnist_normal_x' + str(scale) + '_0'
        ...
        for epoch in range(300):
            for scale in [512]:
                name = 'kmnist_normal_x' + str(scale) + '_' + str(epoch)
                baseline = 'kmnist_align_x' + str(scale) + '_' + str(epoch)
                initialization = 'kmnist_normal_x' + str(scale) + '_0'
